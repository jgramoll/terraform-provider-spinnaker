...
func pipelineCanaryAnalysisConfigResource() *schema.Resource {
	return &schema.Resource{
		Schema: map[string]*schema.Schema{
			"canary_analysis_interval_mins": &schema.Schema{
			...
			"canary_config_id": &schema.Schema{
				Type:        schema.TypeString,
				Description: "Id of the canary config.",
				Required:    true,
			},
			"lifetime_duration": &schema.Schema{
				Type: schema.TypeString,
			...
			"metrics_account_name": &schema.Schema{
				Type:        schema.TypeString,
			...
			"score_thresholds": &schema.Schema{
				Type:     schema.TypeList,
				Required: true,
				MaxItems: 1,
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"marginal": &schema.Schema{
							Type: schema.TypeString,
